...
Prior to plotting the data for each cycle, the resulting dataframes are transformed to a 'long' format, i.e., a column for every variable, and a row for every observation (www.datacarpentry.org), to enable the use of ggplot2 to plot the data (see Section xy, *'Modelling'*).
...
## 3.3 Data Preparation and Modelling for Q2: Does the content of the videos have an impact on the viewing rates across different continents? using absolute values
# 5. Data Preparation 
