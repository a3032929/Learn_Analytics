...
- R: used for the data analysis
- RStudio: integrated development environment to develop report 
- RMarkdown: to produce report
- ggplot2: to produce data visualizations
- ProjectTemplate: to automate project file structure
- Git: version control
...
The key phases of focus from the process are Business Understanding, Data Understanding, Data Preparation and Evaluation (maybe add Modelling)
