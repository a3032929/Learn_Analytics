...
The percentage viewed from each continent, throughout the course is calculated.Then combined with the original '*step_title*' and '*video_duration*' columns.

```{r}
head(continent_pct, 3)
```
