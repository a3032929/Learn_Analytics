...
Secondly, we want to plot a scatter plot to show how the percentage of viewers have changed throughout the course. Same as for question, as mentioned in *'3.2 Construct Data'*, we will take the dataset with the actual number of viewers, then transform it to show the percentage for each new continent value. The resulting percentage data frame is stored in the *'cache'*
...
The video topics will be reordered to the same order as how they run throughout the course for the plots. 
