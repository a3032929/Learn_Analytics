...
REPLACE THIS: - The video duration are likely to be measured in minutes, however the durations spans across a large range of minutes, from 37 minutes (> 1 hours) to 426 minutes (just over 7 hours). The average length of the video is 231 minutes (almost 4 hours). The duration of the video could possibly impact the learners' engagement to the course.

WITH THIS: - The unit for the values of the video duration is not included in the files. The most likely units would be minutes or seconds. Looking at the shortest and longest videos, the range could be either 37 min to 426 min (~7 hours), or 37 seconds to 426 seconds (~7 min). It is unlikely that any single video would last 7 hours, hence it is assumed that the duration is given in seconds. The average time of videos is 231 min (~4 min), which is a realistic value for an online course.
...
### Total number of viewing and features used through the duration of videos (TO DELETE??)
