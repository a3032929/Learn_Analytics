...
## Determine business objectives (background, business obj, business success criteria)
### Background (record knowns about business situation)
...
### Business objective (what does the customer want to accomplish, uncover factors that can influence outcome of project)
...
This study will examine the Cyber Security online course, which is divided into three weekly blocks of study. The course consist of a combination of videos, articles, exercises, discussions, quizzes and tests. As data from videos could act as engagement indicators, therefore the focus will be on the video lectures provider by FutureLearn, which are generally used to form part of a course. 
...
- Data provided by FutureLearn - how many files

- hardware platforms (computing resources)

- software (DM tools, software)
