...
=
- *'Step-activity'*: This data file contains information on the learner_id and the date and time stamps of when they had first visit and last completed a particular step. There are missing data under the *'last_completed_at'* column.
...
```{r run3_totalview_topic_bar, echo=FALSE, , fig.width=11, fig.height=7}
