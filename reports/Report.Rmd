...
There are 7 runs of data. Each run of data were measured several months apart from each other, between mid 2016 - mid 2018. Below is a brief description of each set of data files:
...
- *'Question-response'*: 
- *'Step-activity'*: 
- *'Weekly-sentiment-survey-response'*: 
- *'Team-members'* (not included in run 1): 
- *'Video-stats'* (not included in run 1 and 2): 

ADD HERE: Short description and why they were discarded (e.g. too many missing data points; not clear what data means without further background information, hence not being used for further analysis). 
