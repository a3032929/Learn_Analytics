...
<!-- There appears to be no correlation between the duration of the videos and the number of viewers from each continents.  -->
...
<!-- The resulting dataframe is transformed to a 'long' format to enable plotting of the data in Section *'3.2.6 Modelling'*. -->
<!-- ## All run data prep -->
<!-- ## 5.5 Integrate Data -->
...
The 5%, 10% and 95% range of 'viewed_percentage' columns have been excluded from this investigation because the selected columns provided an even split of data collection points. A prelimary plot of all data showed that there is no additional information in these columns, and their inclusions obscures the trends that can be observed. 

<!-- 5% and 10% are too early into the videos to really provide much information (??) and 95% is very close to 100%, that we can assume if viewers were to watch 95% of the video, they will likely to continue to the entire 100% of the video.  -->
