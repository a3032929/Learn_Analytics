...
# Question 2. Does the content of the videos have an impact on the viewing rates across different continents?
# Data understanding
...
```{r stack_cont3_pct_topic_bar, echo=FALSE, fig.width=11, fig.height=7}
