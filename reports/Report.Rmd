...
The following software sources have been used and are described below under section '1.2.2.1 Requirements':
...
Figure 1 shows the number of viewers for each video based on the topic of the videos and the absolute number of views for each other these videos (run 3 data).
...
Further investigation will look at this behaviour with data from all runs. This will help understand two potential points: (1) Is there a point throughout the duration of the videos (e.g. between 75% and 100%), independent of total duration of the video, where the drop out rate is the largest? (2) Is there a maximum duration of the video after which the learners are decide not to watch the video? This will help answer the question if (1) the content after a certain point in the videos is not of interest for the learners, and (2) how long learners stay engaged for.
...
# Evaluation
## Evaluate results - Assessment of data mining results with respect to business success criteria
...
*Question 2*: The results clearly show that most learners will watch the first video of the course, and the number of learners viewing the videos throughout the course drop significantly within the first week. However between week two and three the drop out of learners is not as high. It is unclear whether the data provided by FutureLearn also collects the number of learners watching preview of videos for the course, or whether FutureLearn gives free access to their learning material for a short period of time, which could reflect on the sudden drop of learners watching the videos within the first week. WHAT WERE THE TOPICS OF THESE BLOCK WEEKS? The first week block contained videos surrounding the topic of *Exploring personal privacy online*. The second week block is on *Online payment security* and the third week block is on *Security in the future home*.

The line chart in Figure 7 and 9, also indicates that there is a clear interest for video 2.1 from learners based in South America. The topic was *Welcome to Week 2: payment security*. Given more time, we could do further analysis to gain insights about the learners' from continents to understand whether there are other factors which could affect the learners’ engagement for certain topics, these factors could include but not limited to political factors of the continent, types of jobs and interest in cyber security within those continents.  

*Question 3*: The results potentially show that the longer a video is the higher risk of the learners’ dropping out earlier during the videos. As most learners drop out after 75% into a video, this could help course designers and providers decide whether to ensure that important course content are placed earlier on the videos. Alternatively, it would be interesting to analyse the video contents in the last 25% of the video for the outliers as discussed in Section 3.3.4. This could help understand if there are any triggers for the drop outs to inform the future design of the videos.

It would be interesting to see if the following would have an impact on the data: [???] If the decision is to be made to make important content appear towards the end of the videos, then a contents page could be provided in the video, to inform the learners what to expect throughout a video and this could potentially keep learners more engaged throughout the video. Depending on the interest of the content, it could affect the number of learners watching the entire length of the videos. 

*Summary*: Based on the data and the analysis in this report, it appears that learners engagement with the course decreases throughout the course (and throughout the duration of the videos). Most learners appear to stop viewing the videos after the first week of the course. For the learners who are seriously interested in the course, they are likely to stay on for week two and week three, hence we see a smaller drop out rate to the course for those two weeks.  


## Review process 
<!--*( resulting models appear to be satisfactory and to satisfy business needs. Did we find correlations to answer the business question?? It is now appropriate to do a more thorough review of the data mining engagement in order to determine if there is any important factor or task that has somehow been overlooked.Summarize the process review and highlight activities that have been missed and those that should be repeated)* -->

The outcome of the investigation was satisfactory for the business needs. However, given more time, further analysis could be undertaken on the impact of video features made available for the viewers. With the right data, it would have been interesting to understand whether learners from different continents prefer to use certain devices to access the video content, depending on how widely available certain devices are in different continents. A interesting analysis could also be considered on whether the captions and transcript features are important for learners are based in continents (and countries)?? which do not speak English predominately. The outcome from this analysis could help optimise the content of videos to ensure that they are in the right format and have the correct features.

In addition, the data could be combined with the data files (e.g. the enrolments.csv) to understand more about the types of learners from each continents, and if the data could be split into separate countries. This could provide further insight to determine if certain topics are of more interest for learners of certain continents and certain countries, which could inform the design of any future courses. For example, we saw that there was potentially more interest for the 'payment security' topics from learners of South America. The enrolment and unenrolment date and time stamps may also give an indication on the average duration that the learners stay on the course and if it indicates that learners drop out quicker after the first week of the course, as they appear to do with the video data. 

As the data was originally collected between 2016-18, the recent pandemic has greatly affected the lives of everyone. Many people were forced to work and study at home, many people lost their jobs, many people had more time to reconsider their career options, many activities have moved online for everyone to access. It will be interesting to analyse and understand what impact has the pandemic had on learners and whether we see more or less engagement from learners viewing the videos.
