# bar chart of each video by continent of all runs
cont_all_AbV_topic_bar_full <- new_cont_all_df_AbV_full %>% 
  ...
  ggplot( aes(x=step_title, y=total)) +
...
cache('cont_all_AbV_topic_bar_full')
