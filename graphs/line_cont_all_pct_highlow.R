# graph to show highest to lowest views through course of all runs
run_all_continuous <- new_cont_all_df_pct_order %>% 
  ...
  geom_line(size=1)+
  geom_point(size=2)+
  ggtitle("Figure XX: Total percentage of viewers from high to lowest in all runs")+
  xlab("")+
